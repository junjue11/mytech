...
#import "NVSchemeModel.h"
#import "SchemeDefine.h"

@implementation NVSchemeModel
...
+ (NSString *)xn_transformUrlLScheme:(NSString *)scheme {
    if ([scheme hasPrefix:@"intent:#Intent;component"]) {
        NVSchemeModel *model = [[NVSchemeModel alloc] initWithScheme:scheme];
        return [NSString stringWithFormat:@"yami://com.yanjing.yami/%@?%@", model.jumpType, [model getParamsText]];
    }
    return scheme;
}
