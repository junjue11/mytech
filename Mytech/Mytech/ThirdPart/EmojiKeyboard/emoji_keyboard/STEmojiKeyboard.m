...
// TODO
#define kSTEmojiKeyboardFrame 0
//#define kSTEmojiKeyboardFrame CGRectMake(0, 0, CGRectGetWidth([UIScreen mainScreen].bounds), 262 + [XNScreenTool getHIBarHeight])
#define kSTEmojiToolBarHeight 30 * kScaleX
...
//    if (self = [super initWithFrame:CGRectMake(0, CGRectGetHeight(kSTEmojiKeyboardFrame)-kSTEmojiToolBarHeight - [XNScreenTool getHIBarHeight], CGRectGetWidth(kSTEmojiKeyboardFrame), kSTEmojiToolBarHeight)]){
//        _beginDelete = NO;
...
//        button.tintColor = [UIColor colorWithRed:132/255.0 green:120/255.0 blue:158/255.0 alpha:0.8];//自己修改
//        button.tintColor = COLOR_BLACK_2;
...
//            button.titleLabel.textColor = COLOR_BLACK_1;
//        }
...
//        UIButton *emojiButton = getButton(CGRectMake(left, 0, w, h),//自己注释
//                                          emoji.type,
//                                          emoji.title);
//        UIButton *emojiButton = getButton(CGRectMake(left, -10 * kScaleX - kBottomSafeHeight, w, h),
//                                          emoji.type,
//                                          emoji.title);
        UIButton *emojiButton = getButton(CGRectMake(left, -10 * kScaleX, w, h),
                                          emoji.type,
                                          emoji.title);
...
//    deleteButton.frame = CGRectMake(left, 0, w, h);//自己注释
//    deleteButton.frame = CGRectMake(left, -10 * kScaleX - kBottomSafeHeight, w, h);
    deleteButton.frame = CGRectMake(left, -10 * kScaleX  , w, h);
